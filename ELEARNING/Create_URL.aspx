<%@ Page Title="" Language="C#" MasterPageFile="~/SiteDosen.Master" AutoEventWireup="true" CodeBehind="Create_URL.aspx.cs" Inherits="ELEARNING.Create_URL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main" class="main">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Adding a new URL to 1 Januari - 7 Januari</h5>
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <div class="card" style="outline: 1px solid grey;">
                                        <div class="card-body pt-4">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-2 col-form-label">External URL</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control">
                                                </div>
                                            </div>
                            ...
                            <div id="flush-collapseSeven" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <div class="card" style="outline: 1px solid grey;">
                                        <div class="card-body pt-4">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Display</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Pop-up width (in pixels)</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Pop-up height (in pixels)</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" type="text">
                                                </div>
                                            </div>
                                    ...
                                    <div class="card" style="outline: 1px solid grey;">
                                        <div class="card-body pt-4">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <label>Some internal Moodle variables may be automatically appended the URL. ???? matching variable</label>
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-2 col-form-label">&amp;parameter=variable</label>
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" />
                                                </div>
                                                <div class="col-sm-5">
                                                    <select class="form-select">
                                                        <option value="1" selected>Choose a variable</option>
                                                        <option value="1">Course id</option>
                                                        <option value="1">Course full name</option>
                                                        <option value="1">Course short name</option>
                                                        <option value="1">Course ID number</option>
                                                        <option value="1">Course summary</option>
                                                        <option value="1">Course format</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                    ...
                    <div class="card-footer">
                        <div class="row mb-3">
                            <div class="col-sm-10">
                                ...
                                &nbsp;&nbsp;
                                <a href="#" class="btn btn-primary">Save and display</a>
                                &nbsp;&nbsp;
