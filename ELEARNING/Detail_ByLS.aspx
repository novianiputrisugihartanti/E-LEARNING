<%@ Page Title="" Language="C#" MasterPageFile="~/SiteDosen.Master" AutoEventWireup="true" CodeBehind="Detail_ByLS.aspx.cs" Inherits="ELEARNING.Detail_ByLS" %>
...
<asp:ScriptManager ID="smMain" runat="server" EnablePageMethods="true" />
      <asp:Repeater ID="repeaterLS" runat="server" >
                    ...
                    <div class="card-body pt-3">
                        <table>
                            <tbody>
                                ...
                                <td style="width: 20%">
                                    <h6><asp:Label runat="server" CssClass="pt-2" ID="lblls"><%# DataBinder.Eval(Container.DataItem, "lok") %></asp:Label></h6>
                                </td>
                                <td style="width: 10%">
                                ...
                                <td style="width: 10%">
                                    <center>
                                        <asp:HyperLink runat="server" CssClass="btn btn-link" NavigateUrl='<%# "Detail_Single_Student.aspx?id=" + DataBinder.Eval(Container.DataItem, "nim")  %>' >Details</asp:HyperLink>
