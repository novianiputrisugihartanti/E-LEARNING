<%@ Page Title="" Language="C#" MasterPageFile="~/SiteDosen.Master" AutoEventWireup="true" CodeBehind="Detail_Student_ByLS_Active.aspx.cs" Inherits="ELEARNING.Detail_Student_ByLS" %>
    ...
    <main id="main" class="main">
        <center>
            <div class="pagetitle">
                <div class="card">
                    <div class="card-body">
                        <h1 class="pt-3">Detail Student - <span class="fw-bold text-dark">Learning Style Active</span></h1>
                    </div>
                </div>
